...
print('loading data')
user = pd.read_json("Twibot22_Dataset/user.json")
label = pd.read_csv("Twibot22_Dataset/label.csv")
...
for each in user['public_metrics']:
    ...
    get_following_followers.append(fracc2)
...
X_user = np.nan_to_num(X_user, nan=0.0, posinf=0.0, neginf=0.0)
y = y.to_numpy()
